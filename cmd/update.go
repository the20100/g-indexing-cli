...
// update self-updates the g-indexing binary by cloning the latest source from GitHub,
...
const repoURL = "https://github.com/the20100/g-indexing-cli"

var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update g-indexing to the latest version from GitHub",
...
func runUpdate(cmd *cobra.Command, args []string) error {
	...
	tmpDir, err := os.MkdirTemp("", "g-indexing-update-*")
	if err != nil {
	...
	newBin := filepath.Join(tmpDir, "g-indexing")
